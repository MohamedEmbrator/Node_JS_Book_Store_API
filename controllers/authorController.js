...
/** 
  ...
  *  @access  public
*/
module.exports.getAllAuthors = asyncHanlder(
  async (req, res) => {
...
/** 
  ...
  *  @access  public
*/
module.exports.getAuthorById = asyncHanlder(
  async (req, res) => {
...
*/
module.exports.createNewAuthor = asyncHanlder(
  async (req, res) => {
    let body = req.body;
...
/** 
  ...
  *  @access  private (Only Admin)
*/
module.exports.updateAuthorData = asyncHanlder(
  async (req, res) => {
    let body = req.body;
...
/** 
  ...
  *  @access  private (Only Admin)
*/
module.exports.deleteAuthor = asyncHanlder(
  async (req, res) => {
    const author = await Author.findById(req.params.id);
    if (author) {
